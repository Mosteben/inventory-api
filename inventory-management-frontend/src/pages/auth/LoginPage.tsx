...
import loginImg from "../../assets/illustrations/illustration-pointing-login.webp";
            ...
            <div className="grid min-h-screen md:grid-cols-2">
                ...
                <div className="relative hidden flex-col justify-between overflow-hidden border-r border-black/[0.06] bg-white p-12 md:flex">
                    ...
                    <div className="relative mx-auto w-full max-w-sm">
                        <div className="absolute -inset-10 -z-10 rounded-full bg-[#FFD6E5]/60 blur-3xl" />
                        <img src={loginImg} alt="Sign in illustration" className="w-full" />
                        <h2 className="mt-6 max-w-sm font-[Sora,sans-serif] text-2xl font-bold leading-tight">
                            Every unit accounted for, in real time.
                        </h2>
                ...
                <div className="flex items-center justify-center p-8">
                    <div className="w-full max-w-[400px]">
                        ...
                        <p className="mt-2 text-sm text-[#6B7280]">
                            Log in to your Inventoryy workspace.
                        </p>
                        ...
                        <p className="mt-6 text-center text-sm text-[#6B7280]">
                            ...
                            <Link to="/register" className="font-semibold text-[#16171B] hover:underline">
                                Sign up
                            </Link>
                        </p>
